...
const skills = [
  ...
  { name: "SqlServer", level: 90, category: "backend" },
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {categories.map((category, key) => (
            <button
              ...
              className={cn(
                "px-5 py-2 rounded-full hover:text-glow text-foreground transition-colors duration-300 capitalize cursor-pointer",
